...
{
    public class EPQCHGEXPSTAT_SMOKE : SeleniumTestScript
    {
...
new SeleniumControl(sDriver,"Change Expense Report/Advance Status", "xpath","//div[@class='navItem'][.='Change Expense Report/Advance Status']").Click();
				...
				catch(Exception ex)
				{
					throw new Exception(TraceMessage("Error performing [LogComment]" , ex.Message));
								...
								try {
				Function.CurrentComponent = "EPQCHGEXPSTAT";
								Function.WaitLoadingFinished(Function.IsCurrentComponentModal(false));

				sDriver.SessionLogger.WriteLine("[EPQCHGEXPSTAT] Perfoming VerifyExists on MainForm...", Logger.MessageType.INF);
				SeleniumControl EPQCHGEXPSTAT_MainForm = new SeleniumControl( sDriver, "MainForm", "xpath", "//div[@id='0']/form[1]");
				Function.AssertEqual(true,EPQCHGEXPSTAT_MainForm.Exists());
				...
				sDriver.SessionLogger.WriteLine("[EPQCHGEXPSTAT] Perfoming VerifyExists on Action...", Logger.MessageType.INF);
				SeleniumControl EPQCHGEXPSTAT_Action = new SeleniumControl( sDriver, "Action", "xpath", "//div[@id='0']/form[1]/descendant::*[@id='ACTION']");
				Function.AssertEqual(true,EPQCHGEXPSTAT_Action.Exists());
