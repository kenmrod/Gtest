...
{
    public class AOPPLNCP_02_SMOKE_POSTREQ : SeleniumTestScript
    {
...
new SeleniumControl(sDriver,"Configure Project Settings", "xpath","//div[@class='navItem'][.='Configure Project Settings']").Click();
				...
				this.ScriptLogger.WriteLine("[PJMSETNG] Performing VerifyExists on InterCompanyWorkOrders_ProjectProcessSettings_SelectBudgetingMethod_AdvancedBudgeting...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,PJMSETNG_InterCompanyWorkOrders_ProjectProcessSettings_SelectBudgetingMethod_AdvancedBudgeting.Exists());
