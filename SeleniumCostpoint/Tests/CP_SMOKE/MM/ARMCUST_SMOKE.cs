...
new SeleniumControl(sDriver,"Manage Customers", "xpath","//div[@class='navItem'][.='Manage Customers']").Click();
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing ClickButtonIfExists on MainForm...", Logger.MessageType.INF);
...
IWebElement formBttn = ARMCUST_MainForm.mElement.FindElements(By.CssSelector("*[title*='Table']")).Count <= 0 ? ARMCUST_MainForm.mElement.FindElements(By.XPath(".//*[contains(text(),'Table')]")).FirstOrDefault() :
ARMCUST_MainForm.mElement.FindElements(By.XPath(".//*[contains(text(),'Table')]")).FirstOrDefault();
...
if (formBttn!=null) { new SeleniumControl(sDriver ,"FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on MainForm...", Logger.MessageType.INF);
				SeleniumControl ARMCUST_MainForm = new SeleniumControl( sDriver, "MainForm", "xpath", "//div[@id='0']/form[1]");
				Function.AssertEqual(true,ARMCUST_MainForm.Exists());
...
mTab.Click();
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on Customer_DefaultAcctsLink...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_Customer_DefaultAcctsLink.Exists());
...
if (formBttn!=null) { new SeleniumControl(sDriver ,"FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on DefaultAcctsForm...", Logger.MessageType.INF);
				SeleniumControl ARMCUST_DefaultAcctsForm = new SeleniumControl( sDriver, "DefaultAcctsForm", "xpath", "//div[translate(@id,'0123456789','')='pr__CPMCUST_CUSTDFLTACCT_CTW_']/ancestor::form[1]");
				Function.AssertEqual(true,ARMCUST_DefaultAcctsForm.Exists());
...
IWebElement formBttn = ARMCUST_DefaultAcctsForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) { new SeleniumControl(sDriver, "Close", formBttn).ScrollIntoViewUsingJavaScript(); formBttn.Click();}
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on Customer_NotesLink...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_Customer_NotesLink.Exists());
...
ARMCUST_Customer_NotesLink.Click(1.5);
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on NotesForm...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_NotesForm.Exists());
	...
	if(formBttn!=null) { new SeleniumControl(sDriver, "Close", formBttn).ScrollIntoViewUsingJavaScript(); formBttn.Click();}
				...
				catch(Exception ex)
				{
					throw new Exception(TraceMessage("Error performing [Close]" , ex.Message));
								...
								try
				{
				this.ScriptLogger.WriteLine("Multi Currency");
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on Customer_MulticurrencyLink...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_Customer_MulticurrencyLink.Exists());
...
ARMCUST_Customer_MulticurrencyLink.Click(1.5);
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on MulticurrencyForm...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_MulticurrencyForm.Exists());
...
IWebElement formBttn = ARMCUST_MulticurrencyForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) { new SeleniumControl(sDriver, "Close", formBttn).ScrollIntoViewUsingJavaScript(); formBttn.Click();}
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on Customer_UserDefinedInfoLink...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_Customer_UserDefinedInfoLink.Exists());
...
if (formBttn!=null) { new SeleniumControl(sDriver ,"FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on UserDefinedInfoForm...", Logger.MessageType.INF);
				SeleniumControl ARMCUST_UserDefinedInfoForm = new SeleniumControl( sDriver, "UserDefinedInfoForm", "xpath", "//div[translate(@id,'0123456789','')='pr__CPMUDINF_UDEFLBL_CHLD_']/ancestor::form[1]");
				Function.AssertEqual(true,ARMCUST_UserDefinedInfoForm.Exists());
...
IWebElement formBttn = ARMCUST_UserDefinedInfoForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) { new SeleniumControl(sDriver, "Close", formBttn).ScrollIntoViewUsingJavaScript(); formBttn.Click();}
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on Customer_CustomerAliasLink...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_Customer_CustomerAliasLink.Exists());
...
ARMCUST_Customer_CustomerAliasLink.Click(1.5);
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on CustomerAlias_Ok...", Logger.MessageType.INF);
				SeleniumControl ARMCUST_CustomerAlias_Ok = new SeleniumControl( sDriver, "CustomerAlias_Ok", "xpath", "//div[translate(@id,'0123456789','')='pr__CPMCUST_CUSTALIAS_CTW_']/ancestor::form[1]/following-sibling::div[1]/descendant::*[@id='bOk']");
				Function.AssertEqual(true,ARMCUST_CustomerAlias_Ok.Exists());
	...
	if(formBttn!=null) { new SeleniumControl(sDriver, "Close", formBttn).ScrollIntoViewUsingJavaScript(); formBttn.Click();}
				...
				catch(Exception ex)
				{
					throw new Exception(TraceMessage("Error performing [Close]" , ex.Message));
								...
								try
				{
				this.ScriptLogger.WriteLine("Customer Address");
...
if (formBttn!=null) { new SeleniumControl(sDriver ,"FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on CustomerAddressForm...", Logger.MessageType.INF);
				SeleniumControl ARMCUST_CustomerAddressForm = new SeleniumControl( sDriver, "CustomerAddressForm", "xpath", "//div[translate(@id,'0123456789','')='pr__CPMCUST_CUSTADDR_CTW_']/ancestor::form[1]");
				Function.AssertEqual(true,ARMCUST_CustomerAddressForm.Exists());
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on CustomerAddress_ContactsLink...", Logger.MessageType.INF);
				...
				Function.AssertEqual(true,ARMCUST_CustomerAddress_ContactsLink.Exists());
...
if (formBttn!=null) { new SeleniumControl(sDriver ,"FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				this.ScriptLogger.WriteLine("[ARMCUST] Performing VerifyExists on ContactsForm...", Logger.MessageType.INF);
				SeleniumControl ARMCUST_ContactsForm = new SeleniumControl( sDriver, "ContactsForm", "xpath", "//div[translate(@id,'0123456789','')='pr__CPMCUST_CUSTADDRCNTACT_CTW_']/ancestor::form[1]");
				Function.AssertEqual(true,ARMCUST_ContactsForm.Exists());
