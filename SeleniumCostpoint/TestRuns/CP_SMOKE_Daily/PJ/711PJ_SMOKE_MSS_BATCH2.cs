...
{
    public class CP711PJ_SMOKE_MSS_BATCH2 : SeleniumTestRun
    {
        public CP711PJ_SMOKE_MSS_BATCH2(Logger SessionLogger) : base(SessionLogger) { }
        ...
        public override void ExecuteTests()
        {
				...
				AddTestScripts(new BLPAOBD_00_SMOKE_PREREQ());
