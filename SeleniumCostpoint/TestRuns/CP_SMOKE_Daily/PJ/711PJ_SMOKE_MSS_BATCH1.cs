...
{
    public class CP711PJ_SMOKE_MSS_BATCH1 : SeleniumTestRun
    {
        public CP711PJ_SMOKE_MSS_BATCH1(Logger SessionLogger) : base(SessionLogger) { }
        ...
        public override void ExecuteTests()
        {
				...
				AddTestScripts(new AOPPLNCP_00_SMOKE_PREREQ());
				AddTestScripts(new AOPPLNCP_SMOKE());
				AddTestScripts(new AOPPLNCP_02_SMOKE_POSTREQ());
