...
{
    public class CP711MM_SMOKE_ORA_BATCH12 : SeleniumTestRun
    {
        public CP711MM_SMOKE_ORA_BATCH12(Logger SessionLogger) : base(SessionLogger) { }
        ...
        public override void ExecuteTests()
        {
                ...
                AddTestScripts(new PPMRQAPL_SMOKE());
