...
{
    public class CP711PE_SMOKE_ORA_BATCH8 : SeleniumTestRun
    {
        public CP711PE_SMOKE_ORA_BATCH8(Logger SessionLogger) : base(SessionLogger) { }
        ...
        public override void ExecuteTests()
        {
				...
				AddTestScripts(new LDMLAD_00_PREREQ());
				AddTestScripts(new LDMLAD_SMOKE());
				AddTestScripts(new LDMLAD_04_POSTREQ());
