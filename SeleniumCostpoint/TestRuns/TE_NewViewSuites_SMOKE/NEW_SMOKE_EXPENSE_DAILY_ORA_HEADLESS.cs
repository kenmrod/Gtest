...
{
    public class NEW_SMOKE_EXPENSE_DAILY_ORA_HEADLESS : SeleniumTestRun
    {
        public NEW_SMOKE_EXPENSE_DAILY_ORA_HEADLESS(Logger SessionLogger) : base(SessionLogger) { }

        public override void ExecuteTests()
        {
SetDefaultArgs(SeleniumDriver.Browser.CHROME_HEADLESS, "TE_DAILY_TE10QCO12AUTOTEST_NEW");
