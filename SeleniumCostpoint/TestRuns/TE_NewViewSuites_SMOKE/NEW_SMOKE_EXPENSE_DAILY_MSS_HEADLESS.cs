...
{
    public class NEW_SMOKE_EXPENSE_DAILY_MSS_HEADLESS : SeleniumTestRun
    {
        public NEW_SMOKE_EXPENSE_DAILY_MSS_HEADLESS(Logger SessionLogger) : base(SessionLogger) { }

        public override void ExecuteTests()
        {
SetDefaultArgs(SeleniumDriver.Browser.CHROME_HEADLESS, "TE_DAILY_T10QCM16AUTOTEST_NEW");
