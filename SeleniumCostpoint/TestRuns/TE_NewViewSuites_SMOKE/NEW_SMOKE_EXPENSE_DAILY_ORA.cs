...
{
    public class NEW_SMOKE_EXPENSE_DAILY_ORA : SeleniumTestRun
    {
        public NEW_SMOKE_EXPENSE_DAILY_ORA(Logger SessionLogger) : base(SessionLogger) { }

        public override void ExecuteTests()
        {
SetDefaultArgs(SeleniumDriver.Browser.CHROME, "TE_DAILY_TE10QCO12AUTOTEST_NEW");
