...
{
    public class NEW_SMOKE_EXPENSE_REG_MSS : SeleniumTestRun
    {
        public NEW_SMOKE_EXPENSE_REG_MSS(Logger SessionLogger) : base(SessionLogger) { }

        public override void ExecuteTests()
        {
SetDefaultArgs(SeleniumDriver.Browser.CHROME, "TE_REG_MSS_TE10AUTOTEST_NEW");
