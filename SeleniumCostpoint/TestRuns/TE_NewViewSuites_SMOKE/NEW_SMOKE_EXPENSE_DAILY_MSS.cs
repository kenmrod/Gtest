...
{
    public class NEW_SMOKE_EXPENSE_DAILY_MSS : SeleniumTestRun
    {
        public NEW_SMOKE_EXPENSE_DAILY_MSS(Logger SessionLogger) : base(SessionLogger) { }

        public override void ExecuteTests()
        {
SetDefaultArgs(SeleniumDriver.Browser.CHROME, "TE_DAILY_T10QCM16AUTOTEST_NEW");
