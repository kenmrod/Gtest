...
{
    public class CLASSIC_SMOKE_EXPENSE_REG_ORA : SeleniumTestRun
    {
        public CLASSIC_SMOKE_EXPENSE_REG_ORA(Logger SessionLogger) : base(SessionLogger) { }

        public override void ExecuteTests()
        {
SetDefaultArgs(SeleniumDriver.Browser.CHROME, "TE_REG_ORA_TE10AUTOTEST_CLASSIC");
