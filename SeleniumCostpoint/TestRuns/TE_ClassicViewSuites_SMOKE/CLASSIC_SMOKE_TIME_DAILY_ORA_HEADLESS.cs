...
{
    public class CLASSIC_SMOKE_TIME_DAILY_ORA_HEADLESS : SeleniumTestRun
    {
        public CLASSIC_SMOKE_TIME_DAILY_ORA_HEADLESS(Logger SessionLogger) : base(SessionLogger) { }
