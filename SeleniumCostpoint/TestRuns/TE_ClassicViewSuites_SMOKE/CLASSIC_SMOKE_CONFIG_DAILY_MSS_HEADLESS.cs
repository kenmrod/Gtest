...
{
    public class CLASSIC_SMOKE_CONFIG_DAILY_MSS_HEADLESS : SeleniumTestRun
    {
        public CLASSIC_SMOKE_CONFIG_DAILY_MSS_HEADLESS (Logger SessionLogger) : base(SessionLogger) { }
